@include('partials.main.admin.AdminNav')
    <div class="drawer lg:drawer-open">
        ...
        <label for="my-drawer-2" aria-label="close sidebar" class="drawer-overlay"></label>
            <ul class="menu bg-base-200 text-base-content min-h-full w-70 p-4 gap-y-2 pt-20 lg:pt-4">
                <h6 class="text-xl mb-4">Site Administration</h6>
                ...
                @endif
                <li><a href="{{ url('/admin/dashboard/posts') }}">
                ...
                <li><a href="{{ url('/admin/dashboard/reports') }}">
                ...
                <li><a href="{{ url('/admin/dashboard/accounts') }}">
                ...
                <li><a href="{{ url('/admin/dashboard/stats') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-house h-6 w-6" viewBox="0 0 16 16">
                ...
                <li><a href="{{ url('/admin/dashboard/monetization') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-person-gear w-6 h-6" viewBox="0 0 16 16">
            ...
            <footer class="absolute bottom-0 left-0 right-0 bg-base-300 text-base-content p-4 text-xs flex flex-row gap-x-4 justify-between border border-base-300">
