@include('partials.main.admin.AdminNav')
    <div class="drawer lg:drawer-open z-1">
        ...
        <div class="drawer-content flex flex-col items-center overflow-scroll">
            ...
            @elseif(request()->is('admin/dashboard/reports'))
                @include('partials.main.admin.pages.ReportManagement')
            ...
            @elseif(request()->is('admin/dashboard/terms-of-service'))
                @include('partials.main.admin.pages.TermsOfService')

            @elseif(request()->is('admin/dashboard/privacy-policy'))
                @include('partials.main.admin.pages.PrivacyPolicy')

            @else
                <!-- Dashboard is Buggy, what the hell! -->
            @endif
        ...
        <div class="drawer-side hide-scrollbar">
            ...
            <ul class="menu bg-base-200 text-base-content min-h-full w-80 p-4 pt-20 lg:pt-4 overflow-auto hide-scrollbar z-100">
                ...
                <li><a href="{{ url('/admin/dashboard') }}" class="{{ Request::is('admin/dashboard') ? 'active' : '' }} mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-database-fill-gear h-6 w-6" viewBox="0 0 16 16">
                ...
                <details class="collapse bg-base-200" open>
                    <summary class="collapse-title collapse-open m-0 p-2">
                        <li><a>
                    ...
                    <div class="collapse-content ml-2 flex flex-col gap-y-2">
                        ...
                        <li><a href="{{ url('/admin/dashboard/accounts') }}" class="{{ Request::is('admin/dashboard/accounts') ? 'active' : '' }}">
