...
<ul class="menu bg-base-200 text-base-content min-h-full w-80 p-4">
    ...
    <div id="alternateDiv" class="hidden card bg-base-200 shadow-md w-full max-w-full border border-base-300 p-4">
    ...
    <ul class="menu border-t border-base-300 m-4">
        <h2 class="my-2 text-2xl">Bookmarked Shelters</h2>
        <li><a>
            <div class="avatar">
        ...
        <li><a>
            ...
            Registered Shelter 2
        </a></li>
    </ul>
    <ul class="menu border-t border-base-300 m-4">
        <h2 class="my-2 text-2xl">Shelters you might be interested in:</h2>
        <li><a>
            <div class="avatar">
                <div class="w-6 h-6 rounded-full">
                    <img src="https://picsum.photos/200" alt="User Avatar">
            ...
            (entries) => {
                entries.forEach((entry) => {
                    if (entry.isIntersecting) {
                        ...
                        alternateDiv.classList.remove("visible");
                    } else {
                        // Observed div is not visible
                        alternateDiv.classList.add("visible");
