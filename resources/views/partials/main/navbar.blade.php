<div class="navbar bg-base-300 lg:sticky relative top-0 z-20">
    <div class="navbar-start">
      <div class="dropdown">
        ...
        <!-- eto yung sa loob ng dropdown pagka pang phone yung screensize -->
        <ul
          tabindex="0"
          class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 lg:w-52 w-auto p-2 shadow">
          <ul class="menu menu-vertical px-1 gap-x-6 gap-y-2">
            <li><a href="{{ url('/home') }}">
      ...
      <!-- Do not show this div if the URL is /some-path PARA SA MESSAGES-->
      @else
        @include('partials.main.logo')

        @if(request()->is('browse'))
          <!-- Do not show this div if the URL is /some-path PARA SA SEARCH BAR-->
        @else
          <input
            type="text"
            placeholder="Search"
