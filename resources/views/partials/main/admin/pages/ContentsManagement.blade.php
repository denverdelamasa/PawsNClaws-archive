...
<section class="body-font">
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-4">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-primary">Announcements Management</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-secondary">
                Lahat ng posts nandito
            </p>
        </div>
...
<section class="body-font">
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-4">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-primary">Events Management</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-secondary">
                Lahat ng posts nandito
            </p>
        </div>
...
<section class="body-font">
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-4">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-primary">Flagged content</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-secondary">
