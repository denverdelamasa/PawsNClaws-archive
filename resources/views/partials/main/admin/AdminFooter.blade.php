...
<footer class="footer flex flex-row justify-between bg-base-300 text-base-content border-base-300 border-t px-10 py-4 z-10">
    <aside class="grid-flow-col flex-col flex items-center pt-4">
