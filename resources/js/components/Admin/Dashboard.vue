...
<section class="body-font">
    <div class="container px-5 py-24 mx-auto flex justify-center flex-col align-middle items-center">
        <div class="flex flex-col text-center w-full mb-4">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-primary">Recent Activities</h1>
...
<section class="body-font">
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-4">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-primary">Pendings</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-secondary">
                Pendings decription
            </p>
        </div>
    ...
    <div class="container mx-auto p-6">
        <div class="card w-4/5 m-auto bg-base-300 shadow-xl">
            <div class="card-body w-full">
              ...
              <!-- Title Input -->
              <div class="mb-4">
                <label for="announcementTitle" class="label">
                  <span class="label-text">Title</span>
                </label>
                <input type="text" id="announcementTitle" name="title" class="input input-bordered w-full" placeholder="Enter announcement title" required />
              </div>
          
              <!-- Caption Input -->
              <div class="mb-4">
                <label for="announcementCaption" class="label">
                  <span class="label-text">Caption</span>
                </label>
                <textarea id="announcementCaption" name="caption" class="textarea textarea-bordered w-full" placeholder="Enter caption" required></textarea>
              </div>
          
              <!-- Media Input -->
              <div class="mb-4">
                <label for="announcementMedia" class="label">
                  <span class="label-text">Thumbnail</span>
                </label>
                <input type="file" id="announcementMedia" name="media" class="file-input file-input-bordered w-full" accept="image/*" />
              </div>
