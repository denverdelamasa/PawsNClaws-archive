...
<div class="h-full w-full bg-base-100 overflow-auto gap-4">
    ...
    <div class="flex flex-col m-2 p-2">
        ...
        <p class="text-lg mt-2">Browse announcements to stay informed about the latest updates and news.</p>

        <div v-if="announcements.length === 0 && searchQuery && !loading" class="text-center p-4">
            <div class="text-4xl mb-4">😿</div>
            <h3 class="text-xl font-semibold text-base-content/80">
                No Announcements found <span v-if="searchQuery">for "{{ searchQuery }}"</span>
            </h3>
        ...
        <div v-else>
            <div v-if="announcements.length > 0">
                <div v-for="announcement in announcements" :key="announcement.announcement_id" class="card bg-base-200 w-full shadow-xl my-4 border border-base-300">
                    ...
                    <div class="badge badge-outline badge-accent gap-x-1">
                    ...
                    <div class="dropdown dropdown-end z-50">
                        ...
                        <li v-if="announcement.shelter_id === currentUserId">
                        ...
                        <li v-if="announcement.shelter_id === currentUserId" @click.prevent="openDeleteModal(announcement.announcement_id)">
                            <a href="#">
                        ...
                        <li v-if="announcement.shelter_id !== currentUserId">
                            <a href="#" @click.prevent="openReportModal(announcement.announcement_id)">
                    ...
                    <div class="card-body mt-0">
                        ...
                        <div class="flex items-center space-x-3 mt-2">
                            ...
                            <div>
                                ...
                                <div class="text-xs">
                                    <span>Posted on: {{ announcement.created_at }}</span>
                                    <template v-if="announcement.created_at !== announcement.updated_at">
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex gap-2 flex-wrap">
                            <!-- Upvote Button -->
                            <button class="btn bg-primary btn-sm text-base-300" @click="likeAnnouncement(announcement.announcement_id)">
                                <svg v-if="announcement.is_liked" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
...
export default {
    ...
    watch: {
        searchQuery(newVal) {
            this.currentPage = 1;
            this.announcements = [];
            this.fetchBrowseAnnouncements(newVal);
        },
    },
    methods: {
        ...
        closeReportModal(){
            this.selectedReportAnnouncementId = null;
        },
        ...
        submitEditAnnouncement() {
            axios.put(`/api/announcement/edit/${this.selectedAnnouncement.announcement_id}`, this.selectedAnnouncement, {
                ...
                .then(response => {
                    ...
                    this.fetchBrowseAnnouncements();  // Refresh the posts list
        ...
        fetchBrowseAnnouncements(search = '') {
            this.loading = true; // Show loader when starting request
            axios.get('/api/browse/announcements', {
                params: { 
                    search,
            ...
            .then(response => {
                const newAnnoucements = response.data.announcements;
                const pagination = response.data.pagination;
                // Append new results or replace if first page
                if (this.currentPage === 1) {
                    this.announcements = newAnnoucements;
                } else {
                    this.announcements = [...this.announcements, ...newAnnoucements];
                }
        ...
        loadMore() {
            if (this.hasMore) {
                this.currentPage++;
                this.fetchBrowseAnnouncements(this.searchQuery);
            }
        },
