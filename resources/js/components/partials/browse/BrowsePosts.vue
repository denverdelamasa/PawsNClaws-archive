...
<div class="h-full w-full bg-base-100 overflow-auto gap-4 p-6">
    ...
    <div class="flex flex-col m-2 p-2 border-b-2 border-base-300">
        ...
        <div v-if="posts.length === 0 && searchQuery && !loading" class="text-center p-4">
            <div class="text-4xl mb-4">😿</div>
            <h3 class="text-xl font-semibold text-base-content/80">
                No Posts found <span v-if="searchQuery">for "{{ searchQuery }}"</span>
            </h3>
                ...
                <div v-for="post in posts" :key="post.post_id" class="card bg-base-200 w-full shadow-xl my-4 border border-base-300">
                    ...
                    <div class="flex justify-end items-end p-4">
                        ...
                        <div class="dropdown dropdown-end z-50">
                            ...
                            <li v-if="post.user_id !== currentUserId" @click.prevent="openReportModal(post.post_id)">
                                <a href="#">
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex gap-2 flex-wrap">
                            <!-- Upvote Button -->
                            <button class="btn bg-primary btn-sm text-base-300" @click="likePost(post.post_id)">
                                <svg v-if="post.is_liked" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <!-- Comments Button -->
                            <button id="commentsBtn" class="btn btn-outline btn-sm flex gap-1 items-center" @click="openCommentsModal(post.post_id)">
...
export default {
    ...
    methods: {
        ...
        submitEditPost() {
            axios.put(`/api/post/edit/${this.selectedPost.post_id}`, this.selectedPost, {
                ...
                .then(response => {
                    ...
                    this.fetchBrowsePosts(); // Refresh the posts list
        ...
        loadMore() {
            if (this.hasMore) {
                this.currentPage++;
                this.fetchBrowsePosts(this.searchQuery);
            }
        },
