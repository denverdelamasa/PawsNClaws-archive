  ...
  <div v-for="announcement in announcements" :key="announcement.announcement_id" class="card bg-base-200 w-full shadow-xl my-4 border border-base-300 w-3/4">
    ...
    <div class="flex justify-end items-end p-4">
      ...
      <div class="dropdown dropdown-end z-50">
        ...
        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-300 rounded-box w-[230px]">
          ...
          <li v-if="announcement.shelter_id !== currentUserId"><a href="#" @click.prevent="openReportModal(announcement.announcement_id)">
    ...
    <div class="card-body">
        ...
        <div class="flex gap-2 flex-wrap">
            ...
            <Comments :isCommentsModalOpen="isCommentsModalOpen" @close="closeCommentsModal" :announcementId="selectedAnnouncementId"/>
...
export default {
  ...
  methods: {
    ...
    async isBookmarked(announcementId) {
      ...
      try {
        await axios.post(`/api/bookmark/${announcementId}/announcement`);
        
        // Find the post and update its like state
        const announcement = this.announcements.find(announcement => announcement.announcement_id === announcementId);
        if (announcement) {
          announcement.is_bookmarked = !announcement.is_bookmarked; // Toggle like state
        }
