  ...
  <footer class="footer bg-base-300 text-base-content p-4 text-xs">
    ...
    <nav>
      ...
      <template v-if="!isLoggedIn">
        <a class="link link-hover" href="/form/login">Log in</a>
        <a class="link link-hover" href="/form/signup">Sign Up</a>
      </template>
...
export default {
  data() {
    return {
      isLoggedIn: false, // Replace with actual logic to determine login status
    };
  },
};
</script>
