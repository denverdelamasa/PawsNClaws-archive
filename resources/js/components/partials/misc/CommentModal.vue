<template>
  <div>
    <!-- Comments Modal -->
    <dialog v-if="isModalOpen" class="modal" @click.self="closeModal">
      <div class="modal-box relative max-w-full w-9/12 h-screen p-8 scrollbar-hidden overflow-auto">
        ...
        <textarea 
          ...
          rows="2"
        ></textarea>
        <button class="btn btn-primary mt-4 btn-sm" @click="postComment">
          ...
          <div class="mt-4 bg-base-300 p-4 rounded-r-xl rounded-b-xl my-4 relative">
            ...
            <div class="dropdown dropdown-end absolute right-4 top-4">
              ...
              <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-300 rounded-box w-40">
                <li><a href="#" @click.prevent="reportComment">
            ...
            <p class="text-base transition-all duration-300">
              This is a sample comment inside the modal. The user can leave their thoughts here regarding the post or event!
            </p>

            <div class="flex gap-2 my-2">
              <button class="btn bg-success btn-sm" @click="upvoteComment">
              ...
              <button class="btn btn-error btn-sm" @click="downvoteComment">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="h-5 w-5 stroke-current">
  ...
  methods: {
    ...
    postComment() {
      if (this.comment.trim()) {
        ...
        this.comment = ''; // Clear comment after posting
      }
    },
    // Report the comment
    reportComment() {
...
<style scoped>
/* Custom styles for modal and comment section */
</style>
